...
class READ_THE_STDF_FILE():
    ...
    def MRR(self,Starting_byte):
        ...
        for i in range(len(self.Full_Rec_Summary['HardBin'])):
            self.Full_Rec_Summary['Hbin_nam'].append(self.HBR_Rec_Summary['Hbin_nam'][self.HBR_Rec_Summary['HbinNum'].index(self.Full_Rec_Summary['HardBin'][i])])
            self.Full_Rec_Summary['Sbin_nam'].append(self.SBR_Rec_Summary['Sbin_nam'][self.SBR_Rec_Summary['SbinNum'].index(self.Full_Rec_Summary['SoftBin'][i])])
        return Starting_byte
