...
class READ_THE_STDF_FILE():
    ...
    def __init__(self,parent=None): #,Input_File
        ...
        self.FTR_Rec_Summary,self.Full_Rec_Summary]
    ...
    def PTR(self,Starting_byte):
        ...
        if str(TestNumber)+TestName not in self.TestNumbers and Starting_byte<self.End_Record_Byte:
            ...
            #LowSpec,Starting_byte='',Starting_byte if OptFlag[5:6]=='1' else self.R4(Starting_byte,1)#;print('Low Spec Value :',LowSpec)            
            #HighSpec,Starting_byte='',Starting_byte if OptFlag[4:5]=='1' else self.R4(Starting_byte,1)#;print('High Spec value :',HighSpec)
    ...
    def PRR(self,Starting_byte):
        ...
        self.PRR_Field_List=[['Part_Flag',Part_Flag],['Num_Test',Num_Test],['HardBin',HardBin],['SiteNum',SiteNum],['SoftBin',SoftBin],['HeadNum',HeadNum],['XCo_ord',XCo_ord],['YCo_ord',YCo_ord],['Testtime',Testtime],['PartId',PartId],['Part_Dis_Txt',Part_Dis_Txt],['PartFix',PartFix],['File_Name',self.STDF_File.name]]
    ...
    def HBR(self,Starting_byte):
        ...
        self.HBR_FIELD_LIST=[['File_Name',self.STDF_File.name],['HeadNum',HeadNum],['SiteNum',SiteNum],['HbinNum',HbinNum],['Hbin_Cnt',Hbin_Cnt],['Hbin_Pf',Hbin_Pf],['Hbin_nam',Hbin_nam]]
    ...
    def SBR(self,Starting_byte):
        ...
        self.SBR_FIELD_LIST=[['File_Name',self.STDF_File.name],['HeadNum',HeadNum],['SiteNum',SiteNum],['SbinNum',SbinNum],['Sbin_Cnt',Sbin_Cnt],['Sbin_Pf',Sbin_Pf],['Sbin_nam',Sbin_nam]]
    ...
    def Encodethedata(self,Starting_byte):
        ...
        while Starting_byte<Size_of_Stdf_file:
            try:
                ...
                if  self.Record_Number==16336:
                    self.Record_Number=16336
