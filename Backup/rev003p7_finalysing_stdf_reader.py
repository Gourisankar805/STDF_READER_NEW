...
class READ_THE_STDF_FILE():
    ...
    def __init__(self,parent=None): #,Input_File
        ...
        self.PRR_Rec_Summary={"File_Name":[],'HeadNum':[],'SiteNum':[],'Part_Flag':[],'Num_Test':[],'HardBin':[],'SoftBin':[],'XCo_ord':[],'YCo_ord':[],'Testtime':[],'PartId':[],'Part_Dis_Txt':[],'PartFix':[]}
        ...
        self.TSR_Rec_Summary={"File_Name":[],'HeadNum':[],'SiteNum':[],'Test_type':[],'TestNumber':[],'Exec_Cnt':[],'Fail_Cnt':[],'Alarm_Cnt':[],'Test_nam':[],'Seq_nam':[],'Test_lbl':[],'Opt_Flag':[],'Test_tim':[],'Test_min':[],'Test_max':[],'Test_sums':[],'Test_sqrs':[]}
        ...
        self.VUR_Rec_Summary={'UPD_NAM':[]}
        self.PSR_Rec_Summary={'CONT_FLG':[],'PSR_INDX':[],'PSR_NAM':[],'OPT_FLG':[],'TOTP_CNT':[],'LOCP_CNT':[]}
        self.NMR_Rec_Summary={'CONT_FLG':[],'TOTM_CNT':[],'LOCM_CNT':[],'PMR_INDX':[],'ATPG_NAM':[]}
        self.CNR_Rec_Summary={'CHN_NUM':[],'BIT_POS':[],'CELL_NAM':[]}
        self.SSR_Rec_Summary={'SSR_NAM':[],'CHN_CNT':[],'CHN_LIST':[]}
        self.SCR_Rec_Summary={'CONT_FLG':[],'CDR_INDX':[],'CHN_NAM':[],'CHN_LEN':[],'SIN_PIN':[],'SOUT_PIN':[],'MSTR_CNT':[],'M_CLKS':[],'SLAV_CNT':[],'S_CLKS':[],'INV_VAL':[],'LST_CNT':[],'CELL_LST':[]}
        self.STR_Rec_Summary={'CONT_FLG':[],'TEST_NUM':[],'HEAD_NUM':[],'SITE_NUM':[],'PSR_REF':[],'TEST_FLG':[],'LOG_TYP':[],'TEST_TXT':[],'ALARM_ID':[],'PROG_TXT':[],'RSLT_TXT':[],'Z_VAL':[],'FMU_FLG':[],'MASK_MAP':[],'FAL_MAP':[],'CYC_CNT':[],'TOTF_CNT':[],'TOTL_CNT':[],'CYC_BASE':[]
        ...
        self.FTR_Rec_Summary={'File_Name':[],'Record_number':[],'TestNumber':[],'TestHeadNumber':[],'SiteNumber':[],'TestFlag':[],'OptFlag':[],'Cycl_Cnt':[],'Rel_V_Addr':[],'Rept_C_Vctr':[],'Num_P_Fail':[],
                'X_Fail_Adrs':[],'Y_Fail_Adrs':[],'Vect_offset':[],'Rtn_PmrIndex_cnt':[],'Pgm_StateIndex':[],'RTN_Index_ary_str':[],'RTN_State_ary_str':[],'Pgm_State_indx_ary_str':[],'Pgm_State_ary_str':[],'Failpin':[],'VectNum':[],'Timesetname':[],'opcode':[],'Test_Txt':[],'AlrmId':[],'ProgmTxt':[],'RsltTxt':[],'Patrn_num':[],'SpinMap':[]}
        ...
        self.Full_Rec_Summary={"File_Name":[],'Setuptime':[],'Strtuptime':[],'Stat_Num':[],'modcode':[],'retestcode':[],'protcode':[],'Burntime':[],'Lotid':[],'Parttype':[],'NodName':[],'TesterType':[],'Jobname':[],'Jobrev':[]
            ,'Sublotid':[],'Opername':[],'TestTemp':[],'FlowId':[],'SetupId':[],'RomCode':[],'TestHeadnumber':[],'TestSiteNumber':[],'Part_Flag':[],'Num_Test':[],'HardBin':[],'Hbin_nam':[],'SoftBin':[],'Sbin_nam':[],'XCo_ord':[],'YCo_ord':[],'Testtime':[],'PartId':[],'Part_Dis_Txt':[],'PartFix':[]}
        ...
        self.Full_FIELD_LIST=['File_Name','Setuptime','Strtuptime','Stat_Num','modcode','retestcode','protcode','Burntime','Lotid','Parttype','NodName','TesterType','Jobname','Jobrev','Sublotid','Opername','TestTemp','FlowId','SetupId','RomCode','TestHeadnumber','TestSiteNumber','Part_Flag','Num_Test','HardBin','Hbin_nam','SoftBin','Sbin_nam','XCo_ord','YCo_ord','Testtime','PartId','Part_Dis_Txt','PartFix']
    ...
    def PTR(self,Starting_byte):
        ...
        if str(TestNumber)+";"+TestName not in self.TestNumbers and Starting_byte<self.End_Record_Byte:
            ...
            TRSE,Starting_byte=self.I1(Starting_byte,1)#;print('Test Result Scaling exponent :',TRSE)
            LLSE,Starting_byte=self.I1(Starting_byte,1)#;print('Low limit scaling exponent :',LLSE)
            HLSE,Starting_byte=self.I1(Starting_byte,1)#;print('High limit scaling exponent :',HLSE)
            LowLim,Starting_byte=self.R4(Starting_byte,1)#;print('Low Limit :',LowLim)
            HighLim,Starting_byte=self.R4(Starting_byte,1)#;print('High limit :',HighLim)
            ...
            if OptFlag[5:6]=='1': LowSpec,Starting_byte='',Starting_byte
            else: LowSpec,Starting_byte=self.R4(Starting_byte,1)
            if OptFlag[4:5]=='1': HighSpec,Starting_byte='',Starting_byte
            else: HighSpec,Starting_byte=self.R4(Starting_byte,1)
    ...
    def MPR(self,Starting_byte):
        ...
        if TestNumber not in self.TestNumbers and Starting_byte<self.End_Record_Byte:
            ...
            TRSE,Starting_byte=self.I1(Starting_byte,1)#;print('RES_SCAL',TRSE)
            LLSE,Starting_byte=self.I1(Starting_byte,1)#;print('LLM_SCAL',LLSE)
            HLSE,Starting_byte=self.I1(Starting_byte,1)#;print('Hlm Scal',HLSE)
            LowLim,Starting_byte=self.R4(Starting_byte,1)#;print('Lo lim',LowLim)
            HighLim,Starting_byte=self.R4(Starting_byte,1)#;print('Hi lim',HighLim)
            ...
            LowSpec,Starting_byte=self.R4(Starting_byte,1)#;print('Lo_spec',LowSpec)
            HighSpec,Starting_byte=self.R4(Starting_byte,1)#;print('Hi_spec',HighSpec)
        ...
        for i in range(0, len(Rtn_indx)):
            ...
            ['Incr_in',Incr_in],['Rtn_indx_str',Rtn_indx_str],['TestUnit',TestUnit],['Units_in',Units_in],['CRFS',CRFS],['CLLFS',CLLFS],['CHLFS',CHLFS],['LowSpec',LowSpec],['HighSpec',HighSpec]]
    ...
    def FTR(self,Starting_byte):
        ...
        TestHeadNumber,Starting_byte=self.U1(Starting_byte,1)#;print('Test Head Number :',TestHeadNumber[0])
        SiteNumber,Starting_byte=self.U1(Starting_byte,1)#;print('Site Number :',SiteNumber[0])        
        TestFlag,Starting_byte=self.I1(Starting_byte,1)#;print('Test Flag :',TestFlag[0])
        TestResult='P' if TestFlag==0 else 'F'
        if  Starting_byte<self.End_Record_Byte:
            OptFlag,Starting_byte=self.B1(Starting_byte,1)#;print('Optional Flag :',OptFlag[0])
            Cycl_Cnt,Starting_byte=self.U4(Starting_byte,1)#;print('Vector Cycle count :',Cycl_Cnt[0])
            Rel_V_Addr,Starting_byte=self.U4(Starting_byte,1)#;print('Relative vector address :',Rel_V_Addr[0])
            Rept_C_Vctr,Starting_byte=self.U4(Starting_byte,1)#;print('Vector Repeat count :',Rept_C_Vctr[0])
            Num_P_Fail,Starting_byte=self.U4(Starting_byte,1)#;print('Pin count with 1 or more Failures',Num_P_Fail[0])
            X_Fail_Adrs,Starting_byte=self.I4(Starting_byte,1)#;print('X Logical dev Fail address :',X_Fail_Adrs[0])
            Y_Fail_Adrs,Starting_byte=self.I4(Starting_byte,1)#;print('Y Logical dev Fail address :',Y_Fail_Adrs[0])
            Vect_offset,Starting_byte=self.I2(Starting_byte,1)#;print('Offset from vector of intrest :',Vect_offset[0])
            #Rtn_PmrIndex_cnt,Starting_byte= self.U2(Starting_byte,1) if Starting_byte < self.End_Record_Byte else '', Starting_byte #;print('PMR indexes return data count :',Rtn_PmrIndex_cnt[0])
            #Pgm_StateIndex,Starting_byte=self.U2(Starting_byte,1) if Starting_byte < self.End_Record_Byte else '', Starting_byte#;print('Programed state index count :',Pgm_StateIndex[0])
            if Starting_byte < self.End_Record_Byte: Rtn_PmrIndex_cnt,Starting_byte= self.U2(Starting_byte,1)
            else: Rtn_PmrIndex_cnt,Starting_byte= '', Starting_byte
            if Starting_byte < self.End_Record_Byte: Pgm_StateIndex,Starting_byte= self.U2(Starting_byte,1)
            else: Pgm_StateIndex,Starting_byte= '', Starting_byte
            ...
            if Starting_byte < self.End_Record_Byte: Failpin,Starting_byte= self.DN(Starting_byte,1)
            else: Failpin,Starting_byte= '', Starting_byte            
        ...
        if str(TestNumber)+";"+TestName not in self.TestNumbers:
            ...
            Dummy_list=[]
            if len(self.Full_Rec_Summary['File_Name'])>=1:
                for i in range(len(self.Full_Rec_Summary['File_Name'])) : Dummy_list.append('')
                self.Full_Rec_Summary[str(TestNumber)+";"+TestName].extend(Dummy_list)
                Dummy_list=[]
            for i in range(Number_of_Tested_devices_per_instant_count) : Dummy_list.append('')
            self.Temp_Rec_Summary[str(TestNumber)+";"+TestName].extend(Dummy_list)            
        elif self.Lists_in_Temp_Rec_Summary_are_empty==True and str(TestNumber)+";"+TestName in self.TestNumbers:
            Dummy_list=[]
            for i in range(Number_of_Tested_devices_per_instant_count) : Dummy_list.append('')
        ...
        ['AlrmId',AlrmId],['ProgmTxt',ProgmTxt],['RsltTxt',RsltTxt],['Patrn_num',Patrn_num],['SpinMap',SpinMap]]		
        for i in range(len(self.FTR_Field_List)): self.FTR_Rec_Summary[self.FTR_Field_List[i][0]].append(self.FTR_Field_List[i][1])
        for i in range(Number_of_Tested_devices_per_instant_count):
            if len(self.Temp_Rec_Summary[str(TestNumber)+";"+TestName])<=len(self.Temp_Rec_Summary['File_Name']) and self.Temp_Rec_Summary['TestHeadnumber'][i]==TestHeadNumber and self.Temp_Rec_Summary['TestSiteNumber'][i]==SiteNumber and self.Temp_Rec_Summary[str(TestNumber)+";"+TestName][i]=='': self.Temp_Rec_Summary[str(TestNumber)+";"+TestName][i]=TestResult; break        
        return Starting_byte
    def PRR(self,Starting_byte):
        ...
        #PartFix,Starting_byte='',Starting_byte if Starting_byte > self.End_Record_Byte else self.BN(Starting_byte,1)#;print('Part repair Info :',PartFix)
        ...
        self.PRR_Field_List=[['Part_Flag',Part_Flag],['Num_Test',Num_Test],['HardBin',str(HardBin)],['SiteNum',SiteNum],['SoftBin',str(SoftBin)],['HeadNum',HeadNum],['XCo_ord',XCo_ord],['YCo_ord',YCo_ord],['Testtime',Testtime],['PartId',PartId],['Part_Dis_Txt',Part_Dis_Txt],['PartFix',PartFix],['File_Name',self.STDF_File.name]]
        for i in range(len(self.PRR_Field_List)): self.PRR_Rec_Summary[self.PRR_Field_List[i][0]].append(self.PRR_Field_List[i][1])
        for i in range(22,34): 
            if i!=25 and i!= 27: self.Temp_Rec_Summary[self.Full_FIELD_LIST[i]].append(self.PRR_Field_List[i-22][1])
    ...
    def TSR(self,Starting_byte):
        ...
        ['Seq_nam',Seq_nam],['Test_lbl',Test_lbl],['Opt_Flag',Opt_Flag],['Test_tim',Test_tim],['Test_min',Test_min],['Test_max',Test_max],['Test_sums',Test_sums],['Test_sqrs',Test_sqrs]]
    ...
    def MRR(self,Starting_byte):
        ...
        for i in range(len(self.Full_Rec_Summary['HardBin'])):
            ...
            elif len(self.HBR_Rec_Summary['HbinNum'])==0:self.Full_Rec_Summary['Hbin_nam'].append(nan)
            ...
            elif len(self.SBR_Rec_Summary['SbinNum'])==0:self.Full_Rec_Summary['Sbin_nam'].append(nan)
    ...
    def VUR(self,Starting_byte):
        ...
        self.VUR_FIELD_LIST=['UPD_NAM',self.UPD_NAM]
    ...
    def PSR(self,Starting_byte):
        ...
        self.PSR_FIELD_LIST=[['CONT_FLG',self.CONT_FLG],['PSR_INDX',self.PSR_INDX],['PSR_NAM',self.PSR_NAM],['OPT_FLG',self.OPT_FLG],['TOTP_CNT',self.TOTP_CNT],['LOCP_CNT',self.LOCP_CNT]]
    ...
    def NMR(self,Starting_byte):
        ...
        self.NMR_FIELD_LIST=[['CONT_FLG',self.CONT_FLG],['TOTM_CNT',self.TOTM_CNT],['LOCM_CNT',self.LOCM_CNT],['PMR_INDX',self.PMR_INDX],['ATPG_NAM',self.ATPG_NAM]]
    ...
    def CNR(self,Starting_byte):
        ...
        self.CNR_FIELD_LIST=[['CHN_NUM',self.CHN_NUM],['BIT_POS',self.BIT_POS],['CELL_NAM',self.CELL_NAM]]
    def SSR(self,Starting_byte):
        ...
        self.SSR_FIELD_LIST=[['SSR_NAM',self.SSR_NAM],['CHN_CNT',self.CHN_CNT],['CHN_LIST',self.CHN_LIST]]
    ...
    def SCR(self,Starting_byte):
        ...
        self.SCR_FIELD_LIST=[['CONT_FLG',self.CONT_FLG],['CDR_INDX',self.CDR_INDX],['CHN_NAM',self.CHN_NAM],['CHN_LEN',self.CHN_LEN],['SIN_PIN',self.SIN_PIN],['SOUT_PIN',self.SOUT_PIN],['MSTR_CNT',self.MSTR_CNT],['M_CLKS',self.M_CLKS],['SLAV_CNT',self.SLAV_CNT],['S_CLKS',self.S_CLKS],['INV_VAL',self.INV_VAL],['LST_CNT',self.LST_CNT],['CELL_LST',self.CELL_LST]]
    ...
    def Encodethedata(self,Starting_byte):
        ...
        while Starting_byte<Size_of_Stdf_file:
            try:
                ...
                if  self.Record_Number==101516:
                    self.Record_Number=101516
